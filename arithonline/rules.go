...
/*
parserRule represents a grammar parserRule of the language. Its lhs is a single token while its rhs is a slice of tokens.
*/
...
*/
var _RULES = []parserRule{
	parserRule{NEW_AXIOM, []uint16{E_F_S_T}},
	parserRule{E_S, []uint16{E_F_S_T, PLUS, E_F_S_T}},
	parserRule{E_S, []uint16{E_F_S_T, PLUS, E_S_T}},
	parserRule{E_S_T, []uint16{E_F_S_T, TIMES, E_F_S_T}},
	parserRule{NEW_AXIOM, []uint16{E_S}},
	parserRule{E_S, []uint16{E_S, PLUS, E_F_S_T}},
	parserRule{E_S, []uint16{E_S, PLUS, E_S_T}},
	parserRule{NEW_AXIOM, []uint16{E_S_T}},
	parserRule{E_S, []uint16{E_S_T, PLUS, E_F_S_T}},
	parserRule{E_S, []uint16{E_S_T, PLUS, E_S_T}},
	parserRule{E_S_T, []uint16{E_S_T, TIMES, E_F_S_T}},
	parserRule{E_F_S_T, []uint16{LPAR, E_F_S_T, RPAR}},
	parserRule{E_F_S_T, []uint16{LPAR, E_S, RPAR}},
	parserRule{E_F_S_T, []uint16{LPAR, E_S_T, RPAR}},
	parserRule{E_F_S_T, []uint16{NUMBER}},
}
